          ...
          <div className="p-3 sm:p-4 border-b border-slate-700 flex-shrink-0">
            <div className="flex items-center gap-2 bg-slate-800 rounded px-3 py-2">
              ...
              <input
                ...
                autoFocus
                className="flex-1 bg-transparent outline-none text-slate-200 placeholder-slate-500 text-sm min-w-0"
              />
              {query && (
                <button
                  onClick={() => {
              ...
              {results.map((result) => (
                ...
                >
                  <div className="flex items-start gap-2 sm:gap-3">
                    <span
                      className={`text-xs font-medium px-1.5 sm:px-2 py-0.5 rounded flex-shrink-0 ${
                        result.type === 'event'
