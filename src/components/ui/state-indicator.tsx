...
const stateConfig: Record<StateType, { icon: ReactNode; bgColor: string; textColor: string; borderColor: string }> = {
  idle: {
    icon: null,
...
export function StateIndicator({ state, message, children, className = '' }: StateIndicatorProps) {
...
export function StateWrapper({
  ...
  switch (state) {
    case 'loading':
      return (
        <StateIndicator state="loading" message={loadingMessage} className={className} />
      );
    case 'error':
      return (
        <StateIndicator state="error" message={errorMessage} className={className} />
      );
    case 'success':
      return (
        <StateIndicator state="success" message={successMessage} className={className} />
      );
    default:
