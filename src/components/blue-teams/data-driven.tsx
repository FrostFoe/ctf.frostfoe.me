...
const content = [
  {
    ...
    image: PlaceHolderImages.find((img) => img.id === "blue-team-analytics")!,
  },
  {
    id: "img-2",
    ...
    image: PlaceHolderImages.find((img) => img.id === "blue-team-heatmaps")!,
  },
  {
    id: "img-3",
    ...
    image: PlaceHolderImages.find((img) => img.id === "blue-team-integration")!,
  },
];
...
export default function DataDriven() {
  ...
  return (
    <section className="w-full">
      <div className="mb-8 rounded-lg border border-blue-500/30 bg-gradient-to-l from-transparent to-blue-950/30 p-8">
          ...
          {content.map((item) => (
            <Card
              ...
              className={cn(
                ...
                activeTab === item.id && "border-blue-500/50 bg-gray-800/50",
              )}
            >
              <CardTitle
                className={cn(
