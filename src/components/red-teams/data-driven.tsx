...
const content = [
  {
    ...
    image: PlaceHolderImages.find((img) => img.id === "red-team-analytics")!,
  },
  {
    id: "img-2",
    ...
    image: PlaceHolderImages.find((img) => img.id === "red-team-heatmaps")!,
  },
  {
    id: "img-3",
    ...
    image: PlaceHolderImages.find((img) => img.id === "red-team-integration")!,
  },
];
...
export default function DataDriven() {
  ...
  return (
    <section className="w-full">
      <div className="mb-8 rounded-lg border border-red-500/30 bg-gradient-to-l from-transparent to-red-950/30 p-8">
