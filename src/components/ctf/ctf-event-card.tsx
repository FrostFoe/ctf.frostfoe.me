...
export default function CtfEventCard({
  ...
  return (
    <div className="group cursor-pointer overflow-hidden rounded-lg border border-slate-700 bg-slate-800/50 backdrop-blur hover:border-slate-600 transition-all">
      {/* Image Container */}
