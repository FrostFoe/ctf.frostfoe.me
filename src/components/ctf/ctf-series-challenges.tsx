    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="space-y-2 sm:space-y-3">
        <div className="flex items-center justify-between gap-2">
          <h3 className="text-base sm:text-lg font-bold text-white">সিরিজ অগ্রগতি</h3>
      ...
      {/* Challenges List */}
      <div className="space-y-2 sm:space-y-3">
        <h3 className="text-base sm:text-lg font-bold text-white">চ্যালেঞ্জ সমূহ</h3>

        {sortedChallenges.length === 0 ? (
          <p className="text-slate-400 text-xs sm:text-sm">কোন চ্যালেঞ্জ পাওয়া যায়নি</p>
        ) : (
