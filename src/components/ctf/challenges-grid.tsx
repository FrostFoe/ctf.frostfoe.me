...
export default function ChallengesGrid({ challenges }: ChallengesGridProps) {
  if (challenges.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-8 sm:py-10 md:py-12 text-center px-4 md:ml-4">
        <svg
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-5 lg:gap-6 w-full md:ml-4">
