...
export default function HeroCarrer() {
  const logos = [
    { src: "https://www.hackthebox.com/images/landingv3/security-metrics-logo.svg", alt: "Security Metrics logo", placeholder: "Security Metrics" },
    { src: "https://www.hackthebox.com/images/landingv3/synack-the-white-logo.svg", alt: "Synack logo", placeholder: "Synack" },
    { src: "https://www.hackthebox.com/images/landingv3/lufthansa-logo.svg", alt: "Lufthansa logo", placeholder: "Lufthansa" },
    { src: "https://www.hackthebox.com/images/landingv3/booking-holdings-logo.svg", alt: "Booking Holdings logo", placeholder: "Booking Holdings" }
  ];
      ...
      <div className="container mx-auto">
        <div className="mb-8">
          <h4 className="text-white text-2xl sm:text-3xl lg:text-4xl font-extrabold leading-tight mb-8">
            Clear career path programs and retention <br className="hidden md:block" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">
          <div className="lg:col-span-7">
            <a className="group w-full h-full" href="https://www.hackthebox.com/blog/a-blueprint-for-onboarding-new-cybersecurity-professionals">
              <div className="bg-gray-800 rounded-lg border border-gray-700 h-full p-6 md:p-8 relative hover:border-gray-500 transition-colors">
                ...
                <div className="flex flex-col sm:flex-row gap-8">
                  <div className="flex-1 border-b sm:border-b-0 sm:border-r border-gray-700 pb-6 sm:pb-0 sm:pr-6">
                    <span className="text-sm text-gray-400 block mb-4 sm:mb-12">Available candidates</span>
                    <span className="text-lime-400 text-6xl md:text-7xl font-extrabold block">908k+</span>
                  </div>
                  <div className="flex-1 pt-6 sm:pt-0">
                    <span className="text-sm text-gray-400 block mb-4 sm:mb-12">Onboarding & retention</span>
          ...
          <div className="lg:col-span-5">
            <a className="group w-full h-full" href="https://www.hackthebox.com/blog/military-operator-to-cyber-threat-intelligence-gary-success-story">
              <div className="bg-gray-800 rounded-lg border border-gray-700 h-full flex flex-col sm:flex-row overflow-hidden relative hover:border-gray-500 transition-colors">
                ...
                <div className="w-full sm:w-2/5 lg:w-full xl:w-5/12 h-48 sm:h-auto">
                  <Image className="w-full h-full object-cover" src="https://www.hackthebox.com/images/landingv3/gary-ruddell-mobile.png" alt="Gary Ruddell" width={200} height={300}
                    onError={(e) => { e.currentTarget.src = 'https://placehold.co/200x300/111927/FFFFFF?text=Gary+R.' }} />
                </div>
              </div>
            </a>
          </div>
        ...
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6 md:p-8">
          <div className="mb-6">
            <span className="text-gray-400 text-base">Companies hiring on Hack The Box</span>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 items-center">
            {logos.map((logo) => (
              <Image key={logo.src} className="w-full h-auto" src={logo.src} alt={logo.alt} width={200} height={50}
                onError={(e) => { e.currentTarget.src = `https://placehold.co/200x50/111927/808080?text=${encodeURIComponent(logo.placeholder)}` }} />
            ))}
          </div>
        </div>
      </div>
