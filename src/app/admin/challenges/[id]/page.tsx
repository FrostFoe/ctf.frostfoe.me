...
import { getChallengeById, getEvents } from "@/lib/supabase/ctf-service";
...
export default function EditChallengePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || "চ্যালেঞ্জ সংরক্ষণ করতে ব্যর্থ");
      }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  handleChange("event_id", parseInt(e.target.value))
                }
            ...
            <div>
              ...
              <input
                type="number"
                min="1"
                value={formData.max_attempts || 999}
                onChange={(e) =>
